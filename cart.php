                ...
                <tbody>
                  <tr>
                    <td class="product-thumbnail">
                      <img src="images/taller (2).jpg" alt="Image" class="img-fluid">
                    </td>
                    <td class="product-name">
                      <h2 class="h5 text-black">Ecuaciones desde Cero</h2>
                    </td>
                    <td>$800.00</td>
                    <td>
                  ...
                  <tr>
                    <td class="product-thumbnail">
                      <img src="images/taller (5).jpg" alt="Image" class="img-fluid">
                    </td>
                    <td class="product-name">
                      <h2 class="h5 text-black">Mi Historia Covid</h2>
                    </td>
                    <td>$350.00</td>
                    <td>
                      <div class="input-group mb-3" style="max-width: 120px;">
              ...
              <div class="col-md-7">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-6 text-right">
                    <strong class="text-black">$1150.00</strong>
                  </div>
                </div>
                <div class="row mb-5">
                  <div class="col-md-6">
