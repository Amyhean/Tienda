...
<html lang="esp">
  <head>
    <title>compras &mdash; e-Commerce</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-12">
            ...
            Soy Cliente <a href="#">Click aquí</a> login
            </div>
          </div>
        </div>
        <div class="row">
            ...
            <div class="p-3 p-lg-5 border">
              <div class="form-group">
                ...
                <select id="c_country" class="form-control">
                  <option value="1">Select tu País</option>    
                  <option value="2">México</option>    
                  <option value="3">Estados Unidos de Norte America</option>    
            ...
            <div class="row mb-5">
              <div class="col-md-12">
                ...
                <div class="p-3 p-lg-5 border">
                  ...
                  <label for="c_code" class="text-black mb-3">introduce tu código</label>
              ...
              <div class="col-md-12">
                ...
                <div class="p-3 p-lg-5 border">
                  <table class="table site-block-order-table mb-5">
                    ...
                    <tbody>
                      <tr>
                        <td>Pagina WEB <strong class="mx-2">x</strong> 1</td>
                        <td>$1355.00</td>
                      </tr>
                      <tr>
                        <td>Clases de Historia <strong class="mx-2">x</strong>   1</td>
                        <td>$800.00</td>
                      </tr>
                      <tr>
                        <td class="text-black font-weight-bold"><strong>Subtotal</strong></td>
                        <td class="text-black">$2155.00</td>
                      </tr>
                      <tr>
                        <td class="text-black font-weight-bold"><strong>Total</strong></td>
                        <td class="text-black font-weight-bold"><strong>$2155.00</strong></td>
                      </tr>
                    </tbody>
                  </table>
                  ...
                  <div class="border p-3 mb-3">
                    <h3 class="h6 mb-0"><a class="d-block" data-toggle="collapse" href="#collapsecheque" role="button" aria-expanded="false" aria-controls="collapsecheque">Pay Pal</a></h3>
                  ...
                  <div class="form-group">
                    <button class="btn btn-primary btn-lg py-3 btn-block" onclick="window.location='thankyou.html'">Orden</button>
                  </div>
